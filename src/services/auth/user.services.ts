...
//     // const licensePhoto = req.files//["licenseDoc"][0];
//     const licensePhoto = req.file || null;
//     const licensePhotoUrl = licensePhoto ? `${req.protocol}://${req.hostname}:${process.env.PORT}/uploads/${licensePhoto.filename}` : null;
...
//     console.log("body:::::::::::::",req.body, req.file, licensePhoto, licensePhotoUrl)
//     const password = req.body.password;//await RegHelper.generatePassword();
//     const encryptedPassword = await EncryptPassword.encryptPassword(password);
//     req.body.password = encryptedPassword;
//     req.body.licenseDoc = licensePhotoUrl;
...
// // export const simpleUserCreate = async (req: any): Promise<IResponse> => {
// //   try {
...
// const getRoles = async (req: any): Promise<IResponse> => {
//   try {
